const gamesData = [
    {
      ...
      gamelocation: "games/doodle-jump-master/index.html"
    },
    {
      id: 2,
      name: "2048",
  ...
  gamesData.map((elem, idx) => {
   if(elem.id%4 == 0){
  games += `<div class=" h-[30vh] relative flex justify-center items-center w-[50vh] rounded-lg bg-[#faf5ed]">
    <h1>Ad</h1>
  </div> `;
   }else{
    games += ` 
    <a href="${elem.gamelocation}" target="_blank" >
    <div id="${idx}" class=" h-[30vh] bg-[url('${elem.gameimg}')] bg-cover bg-center relative w-[50vh] rounded-lg bg-[#faf5ed]">
